...
unlocked to sign the Starshipsha-Qt.app bundle.
...
allowing somebody to distribute a Starshipsha-Qt.app or starshipsha-qt-setup.exe with a valid
...
that the starshipsha-qt.exe file inside the installer had not been tampered with.
