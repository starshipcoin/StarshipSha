...
#if defined(NDEBUG)
# error "Starshipsha cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Starshipsha Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s STAS additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("starshipsha-scriptch");
