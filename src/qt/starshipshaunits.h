...
/** Starshipsha unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StarshipshaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StarshipshaUnits(QObject *parent);

    /** Starshipsha units.
      @note Source: https://en.starshipsha.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STAS,
...
typedef StarshipshaUnits::Unit StarshipshaUnit;
