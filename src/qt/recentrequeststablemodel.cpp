    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return StarshipshaUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, StarshipshaUnits::separatorNever);
            else
                return StarshipshaUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+StarshipshaUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
