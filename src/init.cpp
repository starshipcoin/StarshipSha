 ...
 * between starshipshad, and starshipsha-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("starshipsha-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/starshipsha/starshipsha>";
    const std::string URL_WEBSITE = "<https://starshipshacore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("starshipsha-loadblk");
...
/** Sanity checks
 *  Ensure that Starshipsha is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Starshipsha version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Starshipsha process is using the data directory.
