bitcoin Core version 0.11.0 is now available from:
  ...
  <https://starshipsha.org/bin/starshipsha-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer STAS/kB fee to be
...
For example, add the following to `starshipsha.conf`:
...
related to the blockchain in the starshipsha system: the raw blocks as received over 
...
For an example script see [starshipsha-submittx](https://github.com/laanwj/starshipsha-submittx).
...
- #5334 `cf87536` libstarshipshaconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new starshipsha-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add starshipsha logo to about screen
...
- #5809 `46bfbe7` Add starshipsha-cli man page
...
- #5849 `41259ca` contrib/init/starshipshad.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for starshipsha-tx)
