bitcoin Core version 0.13.2 is now available from:
  ...
  <https://starshipsha.org/bin/starshipsha-core-0.13.2/>
...
- #8908 `4a974b2` Update starshipsha-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow starshipsha-tx to create v2 transactions (btcdrak)
