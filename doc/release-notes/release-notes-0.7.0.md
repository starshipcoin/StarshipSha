bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/starshipsha/files/bitcoin/starshipsha-0.7.0/

We recommend that everybody running prior versions of starshipshad/bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/starshipsha/starshipsha/tarball/v0.7.0  # .tar.gz
  https://github.com/starshipsha/starshipsha/zipball/v0.7.0  # .zip
...
in your terminal, then install the starshipsha-qt package:
  sudo apt-get install starshipsha-qt
...
Core starshipsha handling and blockchain database
...
* Ensure a changed starshipsha unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for starshipsha-qt.exe
* (Windows only): add meta-data to starshipsha-qt.exe (e.g. description)
...
* Bash programmable completion for starshipshad(1)
