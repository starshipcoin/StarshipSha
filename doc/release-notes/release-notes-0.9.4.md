bitcoin Core version 0.9.4 is now available from:
  ...
  https://starshipsha.org/bin/0.9.4/
...
bitcoin Core released binaries from https://starshipsha.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~starshipsha/+archive/ubuntu/starshipsha
