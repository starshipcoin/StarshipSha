Download URL: https://sourceforge.net/projects/starshipsha/files/bitcoin/starshipsha-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 STAS fee schedule (users still pay 0.01 STAS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #starshipsha00 - #starshipsha99
