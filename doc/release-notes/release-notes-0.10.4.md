bitcoin Core version 0.10.4 is now available from:
  ...
  <https://starshipsha.org/bin/starshipsha-core-0.10.4/>
...
- #6953 `43c2789` Split starshipsha-tx into its own package
- #6953 `dfe0d4d` Include starshipsha-tx binary on Debian/Ubuntu
