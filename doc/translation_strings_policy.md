...
This document provides guidelines for internationalization of the Starshipsha Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `starshipsha_en.ts` remains unchanged.
