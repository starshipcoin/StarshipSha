...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the StarshipshaTestFramework
    pass

class ExampleTest(StarshipshaTestFramework):
    # Each functional test is a subclass of the StarshipshaTestFramework class.
    ...
    def custom_method(self):
        ...
        StarshipshaTestFramework class so other tests can use it."""
