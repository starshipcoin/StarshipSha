...
class BIP66Test(StarshipshaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # starshipshad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and starshipshad produces more specific reject
            # reasons.
