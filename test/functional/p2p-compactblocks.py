...
# TestNode: A peer we use to send messages to starshipshad, and store responses.
...
class CompactBlocksTest(StarshipshaTestFramework):
    ...
    # This test actually causes starshipshad to (reasonably!) disconnect us, so do this last.
    ...
    # starshipshad's choice of nonce.
    ...
    # Test that starshipshad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for starshipshad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # starshipshad will not send blocktxn responses for blocks whose height is
